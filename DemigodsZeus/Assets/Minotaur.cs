...
public class Minotaur : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Vector2 targetPosition = new Vector2(playerTarget.transform.position.x, m_body2d.position.y);

        //transform.position = Vector2.MoveTowards(transform.position, playerTransform.position, speed * Time.deltaTime);

        ////Debug.Log(targetPosition.x + ", " + targetPosition.y);
        //Vector2 newPos = Vector2.MoveTowards(m_body2d.position, targetPosition, speed * Time.deltaTime);
